...
namespace InformationSystem
{
    public partial class Map : Form
    {
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                int margin = 300;
                this.Width = screenWidth - margin;
                this.Height = screenHeight - margin;
                this.Location = new Point(margin/2, margin/2);
            }
            else
            {
        ...
        private void Map_Load(object sender, EventArgs e)
        {
            ...
            gMapControl1.Position = new GMap.NET.PointLatLng(55.826400, 45.043095);
        }
